...
{#if !data.showForm}
    <div class="max-w-xl mx-auto">
        ...
        <form
            ...
            <label class="flex flex-col mt-1" for="code">
                Registration code
            </label>
        ...
        <div class="max-w-sm">
            <div>
                ...
                <p class="text-secondary">
                    {#if data.validCode}
                        <span
                            class="text-indigo-700 dark:text-indigo-300 font-bold">
                            Congratulations!
                        </span>
                        Your registration code is valid.
                    {/if}
                    Create an account to start tracking your reading activity and
                    book collection!
                </p>
            </div>
                ...
                <div class="mb-4">
                    ...
                    {#if form?.errors?.code}
                        <p class="text-error text-center">
                            Code: {form?.errors.code[0]}. You should only see
                            this error if something went pretty wrong.
                        </p>
                    {/if}
                </div>
