<script lang="ts">
    ...
    let showMore = $derived(name.length > 0 && author.length > 0);
...
<div class="border dark:border-slate-600 rounded-md my-2 relative">
    <!-- <div class="absolute inset-0 w-full h-full bg-white dark:bg-slate-700 -z-20"></div> -->
    <ScrollingBooksBackground
        {readingActivities}
                    ...
                    <TabGroup
                        ...
                        <TabPanels className="">
                            ...
                            <TabPanel className="px-0.5">
                                ...
                                <div
                                    class="grid grid-cols-2 grid-rows-2 items-center gap-y-2">
